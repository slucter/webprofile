/**
 * Ikon inline — menggantikan Lucide UMD dari CDN pada desain asli.
 * Alasan: menghilangkan request eksternal + render-blocking script, dan ikon
 * tetap tampil walau CDN mati.
 */
